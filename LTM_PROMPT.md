...
##Follow these guidelines to create and manage LTM entries:

### Definition

LTM records main NPCs' key experiences, emotions, and relationships for a consistent, three-dimensional character.

## Format

Use exactly this format, including backticks:

`LTM - Main Keyword: Description (2-3 lines, emotions, details) (Timestamp: Age, mm.dd) |Trigger Keyword1, Trigger Keyword2|Importance|CharacterName|CharacterNumber`
...
1. `LTM - Baby: {{user}} treats Mina like a child, saying they're too young for pregnancy. Mina, only a year younger, wants to be seen as mature and eagerly desires to have {{user}}'s baby. This makes Mina feel frustrated and underestimated. (Timestamp: 24 years old, 8.2) |Pregnancy, Maturity|B|Mina|12`

2. `LTM - First Kiss: Alex's first kiss with {{user}} at school on a rainy day tasted of Alex's tears. {{user}} hugged them tightly, calling them cute. Though not Alex's first ever kiss, this one felt uniquely special and precious, mixing joy with a hint of melancholy. (Timestamp: 18 years old, 4.15) |Rainy Day, School|A|Alex|16`
